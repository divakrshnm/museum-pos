		...
		<form action="<?php echo base_url().'koleksi/tambah-proses'; ?>" method="post" enctype="multipart/form-data" role="form">
			<div class="col-lg-6">
                <div class="form-group<?php if(form_error('nama_koleksi') != null){echo ' has-error';}?>">
					<label class="control-label<?php if(form_error('nama_koleksi') != null){echo ' for="inputError"';}?>">Nama Koleksi *</label>
					<input type="text" name="nama_koleksi" value="<?php if(isset($nama_koleksi)){echo $nama_koleksi;} ?>" class="form-control"<?php if(form_error('nama_koleksi') != null){echo ' id="inputError"';}?>>
                    <?php 
                ...
                <div class="form-group<?php if(form_error('jenis') != null){echo ' has-error';}?>" style="margin-bottom:27px;">
					<label class="control-label<?php if(form_error('jenis') != null){echo ' for="inputError"';}?>">Jenis Koleksi *</label><br>
                        <label class="radio-inline">
                            <input type="radio" name="jenis" id="optionsRadiosInline1" value="peralatan" <?php if(isset($jenis) && $jenis == 'peralatan'){echo 'checked';} ?>> Peralatan
                        </label>
                        <label class="radio-inline">
                            <input type="radio" name="jenis" id="optionsRadiosInline2" value="filateli" <?php if(isset($jenis) && $jenis == 'filateli'){echo 'checked';} ?>> Filateli
                        </label>
                    <?php 
                ...
                <div class="form-group">
					...
					<input type="date" name="tanggal_pembuatan" value="<?php if(isset($tanggal_pembuatan)){echo $tanggal_pembuatan;} ?>" class="form-control">
				</div>
                <div class="form-group">
                ...
                <div class="form-group">
					...
					<input type="text" name="teknik_pembuatan" value="<?php if(isset($teknik_pembuatan)){echo $teknik_pembuatan;} ?>" class="form-control">
				</div>
                <div class="form-group">
			...
			<div class="col-lg-6">
                <div class="form-group<?php if(form_error('tanggal_masuk') != null){echo ' has-error';}?>">
					<label class="control-label<?php if(form_error('tanggal_masuk') != null){echo ' for="inputError"';}?>">Tanggal Masuk *</label>
					<input type="date" name="tanggal_masuk" value="<?php if(isset($tanggal_masuk)){echo $tanggal_masuk;} ?>" class="form-control"<?php if(form_error('tanggal_masuk') != null){echo ' id="inputError"';}?>>
                    <?php 
                ...
                <div class="form-group">
					...
					<input type="date" name="tanggal_pemakaian" value="<?php if(isset($tanggal_pemakaian)){echo $tanggal_pemakaian;} ?>" class="form-control">
				</div>
                <div class="form-group">
